...
// `require_admin` is provided by `risk_management`; remove local duplicate.
...
// AMM types are provided by the `amm` module; no local stubs.
...
impl HelloContract {
    ...
    pub fn amm_swap(env: Env, user: Address, params: crate::amm::SwapParams) -> Result<i128, crate::amm::AmmError> {
