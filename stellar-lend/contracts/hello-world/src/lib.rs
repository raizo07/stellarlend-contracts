...
use risk_management::{
    ...
    require_admin, set_pause_switch, RiskConfig, RiskManagementError,
};
...
impl HelloContract {
    ...
    pub fn liquidate(
        ...
        liquidate(&env, caller, borrower, debt_asset, collateral_asset, amount)
    }
...
// Legacy standalone test modules — API mismatch with current contract surface.
// #[cfg(test)]
// mod test_reentrancy;
// #[cfg(test)]
// mod flash_loan_test;
